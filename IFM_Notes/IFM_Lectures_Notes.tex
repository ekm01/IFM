...
\footnotetext{\textbf{Amortization} is the method that is used to \underline{decrease the cost of the asset over time},df  while \textbf{depreciation} is the \underline{loss in value of the asset over time} Both of them are methods of calculating the value for business assets over time.}
